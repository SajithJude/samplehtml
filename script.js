...
document.getElementById('jsonInput').addEventListener('change', handleFileUpload,{ passive: true });
...
document.getElementById('previewAnimation').addEventListener('click', function () {
    ...
    if (activeObject) {
        ...
        const duration = parseInt(document.getElementById('animationDuration').value, 10);
...
function populateMinimap(data) {
    ...
    data.slides.forEach((slide, index) => {
        ...
        thumbCanvas.loadFromJSON(slide, () => {
            console.log(slide)
            ...
            console.error("A problem occurred while loading the object: ", o, object);
        });
...
function animateObjects(timestamp) {
    ...
    animationQueue.forEach(animation => {
        ...
        if (elapsedTime >= animation.startTime && elapsedTime <= animation.endTime) {
...
function updateControls() {
    ...
    if (activeObject) {
        ...
        if (activeObject.animation) {
            document.getElementById('animationType').value = activeObject.animation.type;
            document.getElementById('animationDuration').value = activeObject.animation.duration;
        }
        ...
        if (activeObject.type === 'textbox') {
            ...
            document.getElementById('justifyContent').value = activeObject.justifyContent || 'flex-start'; // Set default as flex-start
...
document.addEventListener('keydown', function (event) {
    ...
    if (event.ctrlKey && event.key === ' ') {
        ...
        mainCanvasElement.style.backgroundColor = slidesData.slides[currentSlideIndex].canvas.background || '#ffffff';
...
document.getElementById('alignBottom').addEventListener('click', function () {
    let activeObject = mainCanvas.getActiveObject();
    if (activeObject) {
        activeObject.set('top', mainCanvas.height - activeObject.height * activeObject.scaleY).setCoords();
        mainCanvas.requestRenderAll();
    }
});
...
document.getElementById('alignRight').addEventListener('click', function () {
    let activeObject = mainCanvas.getActiveObject();
    if (activeObject) {
        activeObject.set('left', mainCanvas.width - activeObject.width * activeObject.scaleX).setCoords();
        mainCanvas.requestRenderAll();
    }
});

// Center Horizontally
document.getElementById('alignCenterHorizontal').addEventListener('click', function () {
    let activeObject = mainCanvas.getActiveObject();
    if (activeObject) {
        activeObject.set('left', (mainCanvas.width - activeObject.width * activeObject.scaleX) / 2).setCoords();
        mainCanvas.requestRenderAll();
    }
});

// Center Vertically
document.getElementById('alignCenterVertical').addEventListener('click', function () {
    let activeObject = mainCanvas.getActiveObject();
    if (activeObject) {
        activeObject.set('top', (mainCanvas.height - activeObject.height * activeObject.scaleY) / 2).setCoords();
        mainCanvas.requestRenderAll();
    }
});
...
document.getElementById('objectFontSize').addEventListener('change', function () {
    let activeObject = mainCanvas.getActiveObject();
    if (activeObject && activeObject.type === 'i-text') {
...
document.getElementById('objectCharSpacing').addEventListener('change', function () {
    let activeObject = mainCanvas.getActiveObject();
    if (activeObject && activeObject.type === 'i-text') {
...
document.getElementById('objectOpacity').addEventListener('change', function () {
    let activeObject = mainCanvas.getActiveObject();
    if (activeObject) {
